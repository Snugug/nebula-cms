...
function generateCSS(base64Font) {
  return `/* Material Symbols Outlined — subsetted icon font, base64-inlined for zero-latency loading.
 * Generated by scripts/subset-icons.mjs — re-run this script if the icon set changes.
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  /* font-display: block prevents the raw ligature text from flashing before the font loads.
   * Since the font is base64-inlined in this CSS, it loads synchronously with the stylesheet
   * so the block period is effectively zero. */
  font-display: block;
  src: url('data:font/woff2;base64,${base64Font}') format('woff2');
}

/* Base class applied to every icon element in the admin UI. */
.material-symbols-outlined {
  ...
  /* Prevent text transforms from corrupting ligature names */
  text-transform: none;
  display: inline-block;
  white-space: nowrap;
  word-wrap: normal;
  direction: ltr;
  /* Smooth sub-pixel rendering for icon glyphs */
  -webkit-font-smoothing: antialiased;
  text-rendering: optimizeLegibility;
  -moz-osx-font-smoothing: grayscale;
  /* Enable font ligatures so text names render as icon glyphs */
